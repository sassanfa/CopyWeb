...
public static class Localization
{
    private static readonly Dictionary<string, string> English = new(StringComparer.Ordinal)
    {
        ...
        ["عملیات"] = "Actions", ["شروع بررسی سایت"] = "Scan website", ["ادامه پروژه"] = "Resume project", ["توقف و ذخیره"] = "Stop and save", ["تست پروکسی"] = "Test proxy", ["آموزش"] = "Tutorial",
        ...
        ["نسخه 1.3.1"] = "Version 1.3.1", ["نسخه 1.3.0"] = "Version 1.3.0", ["نسخه 1.2.0"] = "Version 1.2.0", ["نسخه 1.1.2"] = "Version 1.1.2", ["نسخه 1.1.0"] = "Version 1.1.0", ["پوشه ذخیره‌سازی"] = "Storage folder", ["حذف پروژه"] = "Delete project", ["چسباندن"] = "Paste", ["چسباندن آدرس"] = "Paste URL", ["متن معتبری در Clipboard وجود ندارد."] = "Clipboard does not contain valid text.", ["نسخه 1.0.18"] = "Version 1.0.18", ["پروژه‌های ذخیره‌شده"] = "Saved projects", ["به‌روزرسانی"] = "Refresh", ["مشاهده لینک‌ها"] = "View links", ["بازکردن پوشه"] = "Open folder", ["بازکردن پوشه گزارش"] = "Open report folder", ["بستن"] = "Close",
