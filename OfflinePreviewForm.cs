...
public sealed class OfflinePreviewForm : Form
{
    ...
    public OfflinePreviewForm(string directory)
    {
        ...
        _server = new OfflinePreviewServer(_directory);
    ...
    private void BuildUi()
    {
        ...
        actions.Controls.AddRange([close, check, open]);
        ...
        root.Controls.Add(_broken); root.Controls.Add(label); root.Controls.Add(actions); root.Controls.Add(_url); root.Controls.Add(title); Controls.Add(root);
    }
